...
const BentoCardClassname = (...className: ClassValue[]) => cn(
    "p-6 group relative col-span-3 overflow-hidden rounded-xl space-y-4",
    ...
    return (
        <>
            ...
            <div className={BentoCardClassname("col-span-1 lg:col-span-2 row-span-2")}>
                <Typography variant="h2" className="text-center">Commandes</Typography>
                <CommandeTable />
                <BorderBeam size={250} duration={12} delay={9} />
            </div>

            <div className={BentoCardClassname("col-span-1 lg:col-span-2 row-span-2")}>
                <Typography variant="h2" className="text-center">Produits</Typography>
                <ProductTable />
                <BorderBeam size={250} duration={12} delay={9} />
            </div>
