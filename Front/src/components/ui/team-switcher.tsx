...
import TemplateForm from "@/app/templates/_components/template/form"
...
export default function TeamSwitcher<TData extends string>({ name, teams, className }: TeamSwitcherProps<TData>) {
    ...
    <Dialog open={showNewTeamDialog} onOpenChange={setShowNewTeamDialog}>
      ...
      <DialogContent>
        <DialogHeader>
          ...
          <DialogDescription>
            Fill in the form below to create a new {name}.
          </DialogDescription>
        </DialogHeader>
